...
const Login = (0, import_index_e286f8ca.c)(($$result, $$props, $$bindings, slots) => {
  let username = "";
  let password = "";
  return `<div class="${"text-center p-2 border container mx-auto m-12 lg:w-2/4 droap-shadow-md rounded-xl shadow-lg"}"><div class="${"text-lg"}">Username</div>
		...
		<div class="${"bg-violet-600 w-max mx-auto p-2 my-2 rounded text-white hover:bg-purple-500 cursor-pointer select-none"}">Log in
		</div>
		${``}</div>`;
});
